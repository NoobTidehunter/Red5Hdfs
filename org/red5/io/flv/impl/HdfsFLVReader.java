 ...
 */
public class HdfsFLVReader implements IoConstants, ITagReader, IKeyFrameDataAnalyzer {
	 ...
	 * Logger
	 */
	private static Logger log = LoggerFactory.getLogger(HdfsFLVReader.class);
	 ...
	 */
	public HdfsFLVReader(File f) throws IOException {
		this(f, false);
	}
	 ...
	 * @throws IOException on error
	 */
	public HdfsFLVReader(File f, boolean generateMetadata) throws IOException {
		/*
		if (null == f) {
		...
		*/
		...
		/**
		channel = Channels.newChannel(new InputStream() {
	 ...
	 */
	public HdfsFLVReader(IoBuffer buffer, boolean generateMetadata) {
		this.generateMetadata = generateMetadata;
		in = buffer;
		postInitialize();
	}
	...
	public void setKeyFrameCache(IKeyFrameMetaCache keyframeCache) {
		HdfsFLVReader.keyframeCache = keyframeCache;
	}
	...
	public static void setBufferType(String bufferType) {
		...
		switch (bufferTypeHash) {
			case 3198444: //heap
				...
				HdfsFLVReader.bufferType = BufferType.HEAP;
				break;
			case -1331586071: //direct
				//Get a direct buffer from buffer pool
				HdfsFLVReader.bufferType = BufferType.DIRECT;
				break;
			case 3005871: //auto
				//Let MINA choose
			default:
				HdfsFLVReader.bufferType = BufferType.AUTO;
		}
	}
	...
	public static void setBufferSize(int bufferSize) {
		...
		HdfsFLVReader.bufferSize = bufferSize;
	}
